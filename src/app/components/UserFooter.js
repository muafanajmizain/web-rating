        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/user" className="text-gray-300 hover:text-white transition">
                  Beranda
                </Link>
              </li>
              <li>
                <Link href="/user/all-rankings" className="text-gray-300 hover:text-white transition">
                  Sekolah
                </Link>
              </li>
              <li>
                <Link href="/user/about" className="text-gray-300 hover:text-white transition">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/user/contact" className="text-gray-300 hover:text-white transition">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/register/reviewer" className="text-gray-300 hover:text-white transition">
                  Daftar Reviewer
                </Link>
              </li>
              <li>

// src/app/components/UserFooter.js
    ...
    <footer className="bg-blue-900 text-white py-12 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Kolom Tengah: Navigasi Cepat */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Navigasi Cepat</h3>
            <ul className="space-y-2">
              <li><Link href="/user" className="text-gray-300 hover:text-white transition">Beranda</Link></li>
              <li><Link href="/user/all-rankings" className="text-gray-300 hover:text-white transition">Sekolah</Link></li>
              <li><Link href="/user/about" className="text-gray-300 hover:text-white transition">About Us</Link></li>
              <li><Link href="/user/contact" className="text-gray-300 hover:text-white transition">Contact</Link></li>
              <li><Link href="/register/reviewer" className="text-gray-300 hover:text-white transition">Daftar Reviewer</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-300">Jl. Jenderal Sudirman No. 123, Purwokerto</span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-300">(0281) 123456 (Admin PC)</span>
              </div>
              ...
              <div className="flex gap-3 mt-4">
                ...
                <a href="#" className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="space-y-4">
                {[
                  {
                    no: "01",
                    text: "Website Sekolah didaftarkan oleh Admin untuk diklaim oleh Pengelola sekolah terkait.",
                  },
                  {
                    no: "02",
                    text: "Pengelola sekolah melengkapi data sekolah miliknya yang telah didaftarkan admin.",
                  },
                  {
                    no: "03",
                    text: "Data yang sudah lengkap akan di Review dan diberi rating oleh Reviewer yang terverivikasi.",
                  },
                  {
                    no: "04",
                    text: "Pengelola sekolah dapat memberi tanggapan atas pembuatan data, lalu dilakukan review ulang jika diperlukan.",
                  },
                  {
                    no: "05",
                    text: "Hasil rating ditampilkan di halaman user publik agar dapat diakses semua orang.",
                  },
                ].map((item, idx) => (

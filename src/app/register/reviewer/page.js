        ...
        React.createElement('div', {
          ...
          React.createElement('div', {
            ...
            React.createElement('div', {
              ...
              React.createElement('input', {
                ...
                className: `w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  showErrors && !formData.pendidikan ? 'border-red-500' : 'border-gray-300'
                }`
              })
            )
          ),
          ...
          React.createElement('div', {
            ...
            React.createElement('div', {
              ...
              React.createElement('input', {
                ...
                className: `w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  showErrors && !formData.profesi ? 'border-red-500' : 'border-gray-300'
                }`
              })
            )
          ),
          ...
          React.createElement('div', {
            ...
            React.createElement('div', {
              ...
              formData.cv && React.createElement('span', {
                className: 'text-sm text-gray-600 truncate max-w-xs'
              }, formData.cv.name)
            ),
            showErrors && !formData.cv && React.createElement('p', {
              className: 'text-xs text-red-500 mt-1'
